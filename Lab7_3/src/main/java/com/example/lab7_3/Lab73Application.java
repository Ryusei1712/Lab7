...
public class Lab73Application {
    ...
    public CommandLineRunner commandLineRunner(StudentRepository studentRepository) {
        return args -> {
            ...
            List<Student> studentsWithAgeGreaterThan21 = studentRepository.findByAgeGreaterThanEqual(21);
            ...
            int countStudentsWithIeltsScore7 = studentRepository.countByIeltsScore(7.0f);
            ...
            System.out.println("Find students whose name contains Dude");
            List<Student> studentsWithNameContainingDude = studentRepository.findByNameContainingIgnoreCase("Dude");
